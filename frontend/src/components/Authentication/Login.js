...
// Custom icon for password input
const CFaLock = chakra(FaLock);
...
const Login = (props) => {
  ...
  const handlesendotp = async (e) => {
    ...
    try {
      ...
      if (response.status !== 200) {
        ...
        showtoast("OTP Sent", "OTP has been sent to your email", "success");
      }
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    ...
    >
      ...
      >
        <Avatar bg="purple.300" size="xl" boxShadow="lg" />
        <Heading color="white" mb={4} fontSize="2xl">
          Welcome Back
        </Heading>
        ...
        >
          <CardBody>
            <form>
              <Stack spacing={4}>
                {forgotpasswordshow && (
                  <Tooltip label="Login" aria-label="A tooltip" hasArrow>
                    <Button
                      w="fit-content"
                      onClick={() => setforgotpasswordshow(false)}
                      size="sm"
                  ...
                  <FormControl>
                    <InputGroup size="lg">
                      ...
                      <Input
                        ...
                        focusBorderColor="purple.500"
                        onChange={(e) => setpassword(e.target.value)}
                        _focus={{ boxShadow: "0 0 0 2px #7928CA" }}
                        transition="0.3s ease-in-out"
                      />
                      <InputRightElement mx={1}>
                        <Button
      ...
      <Box color="white">
        New to us?{" "}
        <Link color="purple.300" onClick={() => handletabs(1)}>
          Sign Up
        </Link>
      </Box>
    </Flex>
